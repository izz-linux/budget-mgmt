...
type Bill struct {
	...
	SinkingFundEnabled  bool             `json:"sinking_fund_enabled"`
	SinkingFundPeriods  *int             `json:"sinking_fund_periods,omitempty"`
...
type UpdateBillRequest struct {
	...
	SinkingFundEnabled  *bool            `json:"sinking_fund_enabled,omitempty"`
	SinkingFundPeriods  *int             `json:"sinking_fund_periods,omitempty"`
}
